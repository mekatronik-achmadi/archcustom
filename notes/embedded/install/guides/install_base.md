...
```sh
cp -vf ../lists/pkg_basic.txt /mnt/mmc/root/home/alarm/basiclist.txt
cp -vf ../lists/pkg_more.txt /mnt/mmc/root/home/alarm/morelist.txt
cp -vf ../lists/pkg_server.txt /mnt/mmc/root/home/alarm/serverlist.txt
cp -vf ../lists/pkg_xorg.txt /mnt/mmc/root/home/alarm/xorglist.txt
```
...
$(cat /home/alarm/xorglist.txt) > /home/alarm/install_pkgs.txt
```
...
#pacman -S --noconfirm $(cat /home/alarm/xorglist.txt)
```

### copy font configuration (host-pc)

```sh
sudo cp -vf ../archfont.conf /mnt/mmc/root/etc/fonts/
```
...
rm -vf /home/alarm/{basiclist.txt,morelist.txt}
rm -vf /home/alarm/{serverlist.txt,xorglist.txt}
